<?php
/*
Plugin Name: WPOddsconverter
Plugin URI: http://www.fullcontactcoding.com/
Version: 0.1
Author: Timothy Oudeboon
Description: plugin that converts decimal odds to either fractional or moneyline odds on a WP page
*/
//create dropdown box

function dropdown_creator()
{
    ?>
    <form action="WPOddsconverter.php" method="post">
...
add_shortcode('convert', 'dropdown_creator');
    ?>
<?php
